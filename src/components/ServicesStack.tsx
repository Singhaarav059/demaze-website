...
export default function ServicesStack() {
  ...
  return (
    <section ref={section} className="bg-paper flex h-screen flex-col overflow-hidden pt-24 pb-6">
      ...
      <div className="mx-auto mt-4 flex w-full max-w-5xl flex-1 items-center px-6">
        {/* The crop has to sit here, not on the section: cards parked below the
            box are still inside the screen and would otherwise show through. */}
