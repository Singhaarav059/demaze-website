...
const projectImage = "/project-investigation.png";
export const Route = createFileRoute("/inside-project")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: "/inside-project" }],
  }),
  ...
  return (
    <PageLayout>
      <main>
        ...
        />
        <section className="case-visual section-wrap">
          <img src={projectImage} alt="MedixCare AI triage product interface" />
        </section>
        <section className="case-content section-wrap">
